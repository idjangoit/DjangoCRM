...
"""
from apps.common.views import HomeView, SignUpView, HomeDashboard, ProfileUpdateView, ProfileView
    ...
    #password reset views 
     path('password-reset/',
         auth_views.PasswordResetView.as_view(template_name='common/password-reset/password_reset.html',
             ...
             email_template_name='common/password-reset/password_reset_email.html', # success_url='/login/'
             ),name='password_reset'),
